    ...
    <body>
        ...
        <div class="imgbkg shadow">
          <div id="button-holder">
               <a href="http://goo.gl/gZ3tmI" target="parent"><button id="sign-button" class="big-button btn btn-primary" type="Create Account" name="Submit">Sign Up!</button></a>
        ...
        <div class="container content-box">
            <div class="row">
            <div class="span12">
               <h1 style="text-align: center">Lehigh's 2nd Annual Game Dev Competition!</h1>
               <p>
